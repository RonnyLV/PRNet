...
from prnet.utils import estimate_pose
from prnet.utils import frontalize
from prnet.utils import get_visibility, get_uv_mask, get_depth_image
from prnet.utils import write_obj_with_colors, write_obj_with_texture
import cv2


def main(args):
    if args.isShow or args.isTexture:
        from prnet.utils import plot_pose_box
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--inputDir', default=os.path.join(os.path.dirname(__file__), 'TestImages/'), type=str,
                        help='path to the input directory, where input images are stored.')
    parser.add_argument('-o', '--outputDir', default=os.path.join(os.path.dirname(__file__), 'TestImages/results'),
                        type=str,
